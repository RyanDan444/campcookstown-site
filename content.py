...
# ---------------------------------------------------------------- questions
GENERAL_FAQ = [
 ("What does my dog need before the first visit?", "Over three months old, healthy, free of fleas and ticks, current on their rabies shot, and spayed or neutered if over nine months. Then a free meet and greet so we can introduce them to a few campers at a time."),
 ...
 ("Can I cancel?", "Yes, any time, at no charge. The one exception is holidays and long weekends. Those dates fill up months ahead, so they take a 50 percent deposit at booking and the deposit stays with the camp if plans change, because a late cancellation means another family missed out on the spot."),
...
TOWNS = {
 'dog-boarding':            ('Dog Boarding near Barrie on 45 Acres | Camp Cookstown', 'Cage free dog boarding at Cookstown, minutes off Highway 400. Days in the field, nights in a heated barn, a counselor on the property every night. First night free.', 'Dog boarding,', 'the camp way.', 'Days on 45 acres, nights in a heated barn with the pack, and a counselor on the property every night.', 'Minutes off Highway 400 by the Tanger Outlets at Cookstown, an easy drive from Barrie, Innisfil, Alliston, Bradford and Newmarket.', 'boarding'),
 ...
 'dog-boarding-barrie':     ('Dog Boarding Barrie | Cage Free on 45 Acres | Camp Cookstown', 'Dog boarding for Barrie families, 25 minutes down the 400 at Cookstown. Days in the field, nights in a heated barn, from $65 a night. First night free.', 'Dog boarding for', 'Barrie families.', 'About 25 minutes from Barrie. Days on 45 acres, nights in a heated barn with the pack, and a counselor on the property every night.', 'Straight down Highway 400 to Cookstown, by the Tanger Outlets. About 25 minutes from Barrie.', 'boarding'),
 ...
 'dog-boarding-newmarket':  ('Dog Boarding Newmarket | Cage Free on 45 Acres | Camp Cookstown', 'Dog boarding for Newmarket families, 35 minutes up the 400 at Cookstown. Days in the field, nights in a heated barn, from $65 a night. First night free.', 'Dog boarding for', 'Newmarket families.', 'About 35 minutes from Newmarket. Days on 45 acres, nights in a heated barn with the pack, and a counselor on the property every night.', 'Up Highway 400 to Cookstown. About 35 minutes from Newmarket, Aurora and East Gwillimbury.', 'boarding'),
 'dog-boarding-innisfil':   ('Dog Boarding Innisfil | Cage Free on 45 Acres | Camp Cookstown', 'Dog boarding for Innisfil families, about 25 minutes from Alcona and Lefroy to camp at Cookstown. Days in the field, nights in a heated barn. First night free.', 'Dog boarding for', 'Innisfil families.', 'About 25 minutes from Alcona and Lefroy. Days on 45 acres, nights in a heated barn with the pack, and a counselor on the property every night.', 'About 25 minutes from Alcona, Lefroy and Stroud.', 'boarding'),
 'dog-boarding-alliston':   ('Dog Boarding Alliston | Cage Free on 45 Acres | Camp Cookstown', 'Dog boarding for Alliston families, about 18 minutes to camp at Cookstown. Days in the field, nights in a heated barn. First night free.', 'Dog boarding for', 'Alliston families.', 'About 18 minutes from Alliston. Days on 45 acres, nights in a heated barn with the pack, and a counselor on the property every night.', 'About 18 minutes from Alliston, 21 from Beeton and 30 from Tottenham.', 'boarding'),
 ...
 'dog-kennel':              ('Dog Kennel near Me | The Camp Version | Camp Cookstown', 'Searching for a dog kennel? Camp Cookstown is the cage free version at Cookstown, minutes off Highway 400. Days in the field, nights in a heated barn.', 'Looking for a', 'dog kennel?', 'Here is the camp version. Days on 45 acres with the pack, nights in a heated barn, and a counselor on the property every night.', 'Minutes off Highway 400 by the Tanger Outlets at Cookstown, an easy drive from Barrie, Innisfil, Alliston, Bradford and Newmarket.', 'kennel'),
 ...
 'dog-boarding-bradford':   ('Dog Boarding Bradford | Cage Free on 45 Acres | Camp Cookstown', 'Dog boarding for Bradford families, about 23 minutes to camp at Cookstown. Days in the field, nights in a heated barn. First night free.', 'Dog boarding for', 'Bradford families.', 'About 23 minutes from Bradford. Days on 45 acres, nights in a heated barn with the pack, and a counselor on the property every night.', 'About 23 minutes from Bradford and Bond Head.', 'boarding'),
 'dog-boarding-aurora':     ('Dog Boarding Aurora | Cage Free on 45 Acres | Camp Cookstown', 'Dog boarding for Aurora families, 40 minutes up the 400 at Cookstown. Days in the field, nights in a heated barn, from $65 a night. First night free.', 'Dog boarding for', 'Aurora families.', 'About 40 minutes from Aurora. Days on 45 acres, nights in a heated barn with the pack, and a counselor on the property every night.', 'Up Highway 400 to Cookstown. About 40 minutes from Aurora.', 'boarding'),
 'dog-boarding-vaughan':    ('Dog Boarding Vaughan | Cage Free on 45 Acres | Camp Cookstown', 'Dog boarding for Vaughan, Woodbridge and Kleinburg families, about 45 minutes up the 400 at Cookstown. Heated barn, fields, first night free.', 'Dog boarding for', 'Vaughan families.', 'About 45 minutes from Vaughan. Days on 45 acres, nights in a heated barn with the pack, and a counselor on the property every night.', 'Up Highway 400 to Cookstown. About 45 minutes from Vaughan, Woodbridge, Maple and Kleinburg.', 'boarding'),
 'dog-boarding-caledon':    ('Dog Boarding Caledon | Cage Free on 45 Acres | Camp Cookstown', 'Dog boarding for Caledon and Bolton families, about 50 minutes to camp at Cookstown. Days in the field, nights in a heated barn. First night free.', 'Dog boarding for', 'Caledon families.', 'About 50 minutes from Caledon. Days on 45 acres, nights in a heated barn with the pack, and a counselor on the property every night.', 'About 45 minutes from Palgrave, 47 from Bolton and 52 from Caledon East.', 'boarding'),
 'dog-boarding-king-city':  ('Dog Boarding King City | Cage Free on 45 Acres | Camp Cookstown', 'Dog boarding for King City, Schomberg and Nobleton families, about 35 minutes up the 400 at Cookstown. Heated barn, fields, first night free.', 'Dog boarding for', 'King City families.', 'About 35 minutes from King City. Days on 45 acres, nights in a heated barn with the pack, and a counselor on the property every night.', 'Up Highway 400 to Cookstown. About 35 minutes from King City, 25 from Schomberg and 35 from Nobleton.', 'boarding'),
 'dog-boarding-east-gwillimbury': ('Dog Boarding East Gwillimbury | Camp Cookstown', 'Dog boarding for East Gwillimbury and Holland Landing families, about 32 minutes to camp at Cookstown. Heated barn, fields, first night free.', 'Dog boarding for', 'East Gwillimbury.', 'About 32 minutes from East Gwillimbury. Days on 45 acres, nights in a heated barn with the pack, and a counselor on the property every night.', 'About 32 minutes from Holland Landing, Sharon, Queensville and Mount Albert.', 'boarding'),
}
